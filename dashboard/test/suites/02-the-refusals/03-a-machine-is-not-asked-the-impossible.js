...
it('a machine that is not dialled in cannot be given a workspace', async ({ actions, assert, log }) => {
...
it('a branch nobody has is not a branch to sync', async ({ actions, assert, log }) => {
