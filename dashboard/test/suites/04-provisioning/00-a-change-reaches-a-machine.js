...
it('the app serves the script that is on disk', async ({ okc, assert, state }) => {
...
it('and the header it promises is on the front of it', async ({ assert, state }) => {
...
it('and the change made to it is in there', async ({ assert, state }) => {
...
it('and a live machine fetching it gets the same thing', async ({ okc, assert, state }) => {
