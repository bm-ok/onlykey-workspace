...
draft('and past the bound, a run that FINISHED is thrown away with the disk', [
  ...
  'unreachable rather than finished" is true and is the easy half. The expensive half is that',
  'a run which FINISHED SUCCESSFULLY at minute three of a twelve-minute outage has its result',
  'sitting on a disk that is then discarded. Nothing reads the machine before the rollback,',
  'and nothing recovers it afterwards. The work was done, it was fine, and it is gone.',
  '',
